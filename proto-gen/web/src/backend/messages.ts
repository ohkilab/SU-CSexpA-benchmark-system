...
export class PingUnaryRequest extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        ping?: string;
    }) {
    ...
    static fromObject(data: {
        ...
        const message = new PingUnaryRequest({});
        if (data.ping != null) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): PingUnaryRequest {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new PingUnaryRequest();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): PingUnaryRequest {
        return PingUnaryRequest.deserialize(bytes);
    }
}
export class PingUnaryResponse extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        pong?: string;
    }) {
    ...
    static fromObject(data: {
        ...
        const message = new PingUnaryResponse({});
        if (data.pong != null) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): PingUnaryResponse {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new PingUnaryResponse();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): PingUnaryResponse {
        return PingUnaryResponse.deserialize(bytes);
    }
}
export class PingServerSideStreamingRequest extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        ping?: string;
    }) {
    ...
    static fromObject(data: {
        ...
        const message = new PingServerSideStreamingRequest({});
        if (data.ping != null) {
            message.ping = data.ping;
        }
        return message;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.ping.length)
            writer.writeString(2, this.ping);
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): PingServerSideStreamingRequest {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new PingServerSideStreamingRequest();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): PingServerSideStreamingRequest {
        return PingServerSideStreamingRequest.deserialize(bytes);
    }
}
export class PingServerSideStreamingResponse extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        pong?: string;
    }) {
    ...
    static fromObject(data: {
        pong?: string;
    }): PingServerSideStreamingResponse {
        const message = new PingServerSideStreamingResponse({});
        if (data.pong != null) {
            message.pong = data.pong;
        }
        return message;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.pong.length)
            writer.writeString(2, this.pong);
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): PingServerSideStreamingResponse {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new PingServerSideStreamingResponse();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): PingServerSideStreamingResponse {
        return PingServerSideStreamingResponse.deserialize(bytes);
    }
}
