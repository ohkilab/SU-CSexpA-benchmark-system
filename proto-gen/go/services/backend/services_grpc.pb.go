...
const (
	...
	AdminService_DeleteContest_FullMethodName = "/backend.AdminService/DeleteContest"
	AdminService_CreateGroups_FullMethodName  = "/backend.AdminService/CreateGroups"
	AdminService_ListGroups_FullMethodName    = "/backend.AdminService/ListGroups"
	AdminService_DeleteGroup_FullMethodName   = "/backend.AdminService/DeleteGroup"
)
...
func (c *adminServiceClient) DeleteContest(ctx context.Context, in *DeleteContestRequest, opts ...grpc.CallOption) (*DeleteContestResponse, error) {
	out := new(DeleteContestResponse)
	err := c.cc.Invoke(ctx, AdminService_DeleteContest_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *adminServiceClient) DeleteGroup(ctx context.Context, in *DeleteGroupRequest, opts ...grpc.CallOption) (*DeleteGroupResponse, error) {
...
func (UnimplementedAdminServiceServer) DeleteContest(context.Context, *DeleteContestRequest) (*DeleteContestResponse, error) {
...
func (UnimplementedAdminServiceServer) DeleteGroup(context.Context, *DeleteGroupRequest) (*DeleteGroupResponse, error) {
...
func _AdminService_DeleteContest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteContestRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServiceServer).DeleteContest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminService_DeleteContest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).DeleteContest(ctx, req.(*DeleteContestRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AdminService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AdminService_DeleteContest_Handler,
		},
		{
