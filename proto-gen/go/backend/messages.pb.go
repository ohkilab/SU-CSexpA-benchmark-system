...
var file_backend_messages_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6e, 0x74, 0x65, 0x73, 0x74, 0x73, 0x42, 0x44, 0x5a, 0x42, 0x67, 0x69, 0x74, 0x68,
	...
	0x67, 0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x2f, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x62, 0x06,
...
var file_backend_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_backend_messages_proto_goTypes = []interface{}{
	...
	(*GetGroupResponse_GroupInfo)(nil),      // 19: backend.GetGroupResponse.GroupInfo
	(*Group)(nil),                           // 20: backend.Group
	(*timestamppb.Timestamp)(nil),           // 21: google.protobuf.Timestamp
	(*Submit)(nil),                          // 22: backend.Submit
	(Status)(0),                             // 23: backend.Status
	(*Contest)(nil),                         // 24: backend.Contest
}
var file_backend_messages_proto_depIdxs = []int32{
	20, // 0: backend.PostLoginResponse.group:type_name -> backend.Group
	21, // 1: backend.PostSubmitResponse.submited_at:type_name -> google.protobuf.Timestamp
	22, // 2: backend.GetSubmitResponse.submit:type_name -> backend.Submit
	23, // 3: backend.ListSubmitsRequest.status:type_name -> backend.Status
	22, // 4: backend.ListSubmitsResponse.submits:type_name -> backend.Submit
	18, // 5: backend.GetRankingResponse.records:type_name -> backend.GetRankingResponse.Record
	19, // 6: backend.GetGroupResponse.groups:type_name -> backend.GetGroupResponse.GroupInfo
	24, // 7: backend.ListContestsResponse.contests:type_name -> backend.Contest
	20, // 8: backend.GetRankingResponse.Record.group:type_name -> backend.Group
	20, // 9: backend.GetGroupResponse.GroupInfo.group:type_name -> backend.Group
	22, // 10: backend.GetGroupResponse.GroupInfo.submits:type_name -> backend.Submit
