...
var _Version_one_of_decls, _CodeGeneratorRequest_one_of_decls, _CodeGeneratorResponse_one_of_decls;
...
class Version extends pb_1.Message {
    constructor(data) {
        super();
        _Version_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _Version_one_of_decls, "f"));
...
_Version_one_of_decls = new WeakMap();
class CodeGeneratorRequest extends pb_1.Message {
    constructor(data) {
        super();
        _CodeGeneratorRequest_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1, 15], __classPrivateFieldGet(this, _CodeGeneratorRequest_one_of_decls, "f"));
        if (!Array.isArray(data) && typeof data == "object") {
    ...
    toObject() {
        ...
        if (this.proto_file != null) {
            data.proto_file = this.proto_file.map((item) => item.toObject());
        }
...
_CodeGeneratorRequest_one_of_decls = new WeakMap();
class CodeGeneratorResponse extends pb_1.Message {
    constructor(data) {
        super();
        _CodeGeneratorResponse_one_of_decls.set(this, []);
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [15], __classPrivateFieldGet(this, _CodeGeneratorResponse_one_of_decls, "f"));
        if (!Array.isArray(data) && typeof data == "object") {
...
_CodeGeneratorResponse_one_of_decls = new WeakMap();
(function (CodeGeneratorResponse) {
    var _File_one_of_decls;
    let Feature;
    (function (Feature) {
    ...
    class File extends pb_1.Message {
        constructor(data) {
            super();
            _File_one_of_decls.set(this, []);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _File_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
    ...
    _File_one_of_decls = new WeakMap();
